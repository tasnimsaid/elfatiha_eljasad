...
document.getElementById("laa2").innerHTML=Counter2*2720;

document.getElementById("haa").innerHTML=Counter3;
document.getElementById("haa3").innerHTML=Counter3*4080;

document.getElementById("mim").innerHTML=Counter4;
document.getElementById("mim4").innerHTML=Counter4*5440;

document.getElementById("dal").innerHTML=Counter5;
document.getElementById("dal5").innerHTML=Counter5*6800;

document.getElementById("haae").innerHTML=Counter6;
document.getElementById("haae6").innerHTML=Counter6*8160;

document.getElementById("raa").innerHTML=Counter7;
document.getElementById("raa7").innerHTML=Counter7*9520;

document.getElementById("baa").innerHTML=Counter8;
document.getElementById("baa8").innerHTML=Counter8*10880;

document.getElementById("ine").innerHTML=Counter9;
document.getElementById("ine9").innerHTML=Counter9*12240;
...
document.getElementById("noon11").innerHTML=Counter11*14960;

document.getElementById("kaf").innerHTML=Counter12;
document.getElementById("kaf12").innerHTML=Counter12*16320;


document.getElementById("ouaou").innerHTML=Counter13;
document.getElementById("ouaou13").innerHTML=Counter13*17680;


document.getElementById("sin").innerHTML=Counter14;
document.getElementById("sin14").innerHTML=Counter14*19040;

document.getElementById("taa").innerHTML=Counter15;
document.getElementById("taa15").innerHTML=Counter15*20400;

document.getElementById("saad").innerHTML=Counter16;
document.getElementById("saad16").innerHTML=Counter16*21760;

document.getElementById("ttae").innerHTML=Counter17;
document.getElementById("ttae17").innerHTML=Counter17*23120;

document.getElementById("ppaf").innerHTML=Counter18;
document.getElementById("ppaf18").innerHTML=Counter18*24480;


document.getElementById("ddal").innerHTML=Counter19;
document.getElementById("ddal19").innerHTML=Counter19*25840;

document.getElementById("gaa").innerHTML=Counter20;
document.getElementById("gaa20").innerHTML=Counter20*27200;

document.getElementById("daa").innerHTML=Counter21;
document.getElementById("daa21").innerHTML=Counter21*28560;

document.getElementById("faa").innerHTML=Counter22;
document.getElementById("faa22").innerHTML=Counter22*29920;

document.getElementById("zay").innerHTML=Counter23;
document.getElementById("zay23").innerHTML=Counter23*31280;

document.getElementById("kha").innerHTML=Counter24;
document.getElementById("kha24").innerHTML=Counter24*32640;

document.getElementById("chine").innerHTML=Counter25;
document.getElementById("chine25").innerHTML=Counter25*34000;

document.getElementById("ddda").innerHTML=Counter26;
document.getElementById("ddda26").innerHTML=Counter26*35360;

document.getElementById("jim").innerHTML=Counter27;
document.getElementById("jim27").innerHTML=Counter27*36720;

document.getElementById("ttta").innerHTML=Counter28;
document.getElementById("ttta28").innerHTML=Counter28*36720;
...
document.getElementById("best3").innerHTML= Counter1*1360 + Counter2*2720 + Counter3*4080 + Counter4*5440 + Counter5*6800 + Counter6*8160 + Counter7*9520 + Counter8*10880 + Counter9*12240 + Counter10*13600 + Counter11*14960 + Counter12*16320 + Counter13*17680 + Counter14*19040 + Counter15*20400 + Counter16*21760 + Counter17*23120 + Counter18*24480 + Counter19*25840 + Counter20*27200 + Counter21*28560 + Counter22*29920 + Counter23*31280 + Counter24*32640 + Counter25*34000 + Counter26*35360 + Counter27*36720 + Counter28*38080  ;
...
var
  ...
  document.getElementById("core1").innerHTML= (roma * 8000)+4 ;      
  ...
  var soft = document.getElementById("kon99").innerHTML

  document.getElementById("kon1").innerHTML= soft+1 ;      
  document.getElementById("kon4").innerHTML= soft+4 ;      
  document.getElementById("kon2").innerHTML= soft+2 ;      
  document.getElementById("kon3").innerHTML= soft+3 ;      
...
var blanco1 = salati - 1 ;
var blanco2 = salati - 2 ;
var blanco3 = salati - 3 ;
var blanco4 = salati - 4 ;


document.getElementById("ayak").innerHTML= salati ;
document.getElementById("ayaks").innerHTML= salati ;
 document.getElementById("ayak1").innerHTML= blanco1 ;
